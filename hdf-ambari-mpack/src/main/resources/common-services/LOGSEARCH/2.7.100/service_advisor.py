...
class LogSearchServiceAdvisor(service_advisor.ServiceAdvisor):
  ...
  def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
    ...
    if ambari_sso_details:
      if ambari_sso_details.should_enable_sso('LOGSEARCH'):
        putLogSearchProperty('logsearch.auth.jwt.enabled', "true")
        putLogSearchProperty('logsearch.auth.jwt.provider_url', ambari_sso_details.get_sso_provider_url())
        putLogSearchProperty('logsearch.auth.jwt.public_key', ambari_sso_details.get_sso_provider_certificate(False, True))
      elif ambari_sso_details.should_disable_sso('LOGSEARCH'):
        putLogSearchProperty('logsearch.auth.jwt.enabled', "false")
