...
def setup_ranger_nifi(upgrade_type=None):
    ...
    if params.has_ranger_admin and params.enable_ranger_nifi:
        ...
        setup_ranger_plugin('nifi-server', 'nifi', params.previous_jdbc_jar,
                            ...
                            component_list=['nifi-server'], audit_db_is_enabled=params.xa_audit_db_is_enabled,
