...
class STREAMLINE050ServiceAdvisor(service_advisor.ServiceAdvisor):
  ...
  def getServiceConfigurationRecommenderDict(self):
    ...
    print("Called STREAMLINE getServiceConfigurationRecommenderDict")
  ...
  def getServiceConfigurationValidators(self):
    ...
    print("Called STREAMLINE getServiceConfigurationValidators")
  ...
  def recommendConfigurations(self, configurations, clusterData, services, hosts):
    ...
    """
    # Logger.info("Class: %s, Method: %s. Recommending Service Configurations." % (self.__class__.__name__, inspect.stack()[0][3]))
    print("Called STREAMLINE recommendConfigurations")
    pass

  def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):

    # Logger.info("Class: %s, Method: %s. Validating Configurations." % (self.__class__.__name__, inspect.stack()[0][3]))
    print("Called STREAMLINE getServiceConfigurationRecommendations")
    ...
    if 'STORM' in servicesList and security_enabled:
      ...
      #streamline_common_site = self.getServicesSiteProperties(services, "streamline-common")
      ...
      if _streamline_principal_name is not None and storm_nimbus_impersonation_acl is not None:
        ...
        storm_nimbus_impersonation_acl = storm_nimbus_impersonation_acl.replace('{{streamline_bare_principal}}',
  ...
  def getServiceConfigurationsValidationItems(self, configurations, recommendedDefaults, services, hosts):
    ...
    """
    # Logger.info("Class: %s, Method: %s. Validating Configurations." % (self.__class__.__name__, inspect.stack()[0][3]))
    print("Called STREAMLINE getServiceConfigurationsValidationItems")
    items = []
    return items

  def getCardinalitiesDict(self, hosts):
      print("Called STREAMLINE getCardinalitiesDict")
