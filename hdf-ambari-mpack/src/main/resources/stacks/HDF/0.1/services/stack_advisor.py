...
class HDF01StackAdvisor(HDF006StackAdvisor):

  def getServiceConfigurationRecommenderDict(self):
    parentRecommendConfDict = super(HDF01StackAdvisor, self).getServiceConfigurationRecommenderDict()
  ...
  def getComponentLayoutSchemes(self):
    parentSchemes = super(HDF01StackAdvisor, self).getComponentLayoutSchemes()
    childSchemes = {
  ...
  def getServiceConfigurationValidators(self):
    parentValidators = super(HDF01StackAdvisor, self).getServiceConfigurationValidators()
    childValidators = {
