...
class HDF03StackAdvisor(HDF02StackAdvisor):

  def createComponentLayoutRecommendations(self, services, hosts):
    parentComponentLayoutRecommendations = super(HDF03StackAdvisor, self).createComponentLayoutRecommendations(services, hosts)
  ...
  def getComponentLayoutValidations(self, services, hosts):
    parentItems = super(HDF03StackAdvisor, self).getComponentLayoutValidations(services, hosts)
  ...
  def getNotPreferableOnServerComponents(self):
    parentComponents = super(HDF03StackAdvisor, self).getNotPreferableOnServerComponents()
    parentComponents.extend(['HAWQMASTER', 'HAWQSTANDBY'])
    return parentComponents

  def getComponentLayoutSchemes(self):
    parentSchemes = super(HDF03StackAdvisor, self).getComponentLayoutSchemes()
  ...
  def getServiceConfigurationRecommenderDict(self):
    parentRecommendConfDict = super(HDF03StackAdvisor, self).getServiceConfigurationRecommenderDict()
  ...
  def recommendTezConfigurations(self, configurations, clusterData, services, hosts):
    super(HDF03StackAdvisor, self).recommendTezConfigurations(configurations, clusterData, services, hosts)
    ...
    # in HDF 0.3 "tez.runtime.sorter.class" is set by default to PIPELINED, in other case comment calculation code below
      ...
      if os.path.exists(views_work_dir) and os.path.isdir(views_work_dir):
        ...
        for file in os.listdir(views_work_dir):
          if fnmatch.fnmatch(file, 'TEZ{*}'):
            current_version = file.lstrip("TEZ{").rstrip("}") # E.g.: TEZ{0.7.0.0.3.0.0-2154}
  ...
  def recommendHBASEConfigurations(self, configurations, clusterData, services, hosts):
    super(HDF03StackAdvisor, self).recommendHBASEConfigurations(configurations, clusterData, services, hosts)
    ...
    if (int(clusterData["hbaseRam"]) > threshold):
      ...
      # 0.2 stack method was called earlier, unset
  ...
  def recommendHIVEConfigurations(self, configurations, clusterData, services, hosts):
    super(HDF03StackAdvisor, self).recommendHIVEConfigurations(configurations, clusterData, services, hosts)
  ...
  def recommendHDFSConfigurations(self, configurations, clusterData, services, hosts):
    super(HDF03StackAdvisor, self).recommendHDFSConfigurations(configurations, clusterData, services, hosts)
  ...
  def recommendRangerConfigurations(self, configurations, clusterData, services, hosts):
    super(HDF03StackAdvisor, self).recommendRangerConfigurations(configurations, clusterData, services, hosts)
    servicesList = [service["StackServices"]["service_name"] for service in services["services"]]
  ...
  def recommendYARNConfigurations(self, configurations, clusterData, services, hosts):
    super(HDF03StackAdvisor, self).recommendYARNConfigurations(configurations, clusterData, services, hosts)
  ...
  def getServiceConfigurationValidators(self):
    parentValidators = super(HDF03StackAdvisor, self).getServiceConfigurationValidators()
    childValidators = {
  ...
  def validateHDFSConfigurations(self, properties, recommendedDefaults, configurations, services, hosts):
    parentValidationProblems = super(HDF03StackAdvisor, self).validateHDFSConfigurations(properties, recommendedDefaults, configurations, services, hosts)
  ...
  def validateHiveConfigurations(self, properties, recommendedDefaults, configurations, services, hosts):
    parentValidationProblems = super(HDF03StackAdvisor, self).validateHiveConfigurations(properties, recommendedDefaults, configurations, services, hosts)
  ...
  def validateHiveServer2Configurations(self, properties, recommendedDefaults, configurations, services, hosts):
    super(HDF03StackAdvisor, self).validateHiveServer2Configurations(properties, recommendedDefaults, configurations, services, hosts)
  ...
  def validateHBASEConfigurations(self, properties, recommendedDefaults, configurations, services, hosts):
    super(HDF03StackAdvisor, self).validateHBASEConfigurations(properties, recommendedDefaults, configurations, services, hosts)
  ...
  def validateHAWQSiteConfigurations(self, properties, recommendedDefaults, configurations, services, hosts):
    ...
    # 0.1 Check if any master or segment directories has multiple values
    directories = {
                    'hawq_master_directory': 'HAWQ Master directory',
                    'hawq_segment_directory': 'HAWQ Segment directory'
                  }
