...
class HDF006StackAdvisor(DefaultStackAdvisor):
  ...
  def getComponentLayoutValidations(self, services, hosts):
    ...
    hostsSet =  set(super(HDF006StackAdvisor, self).getActiveHosts([host["Hosts"] for host in hosts["items"]]))  #[host["Hosts"]["host_name"] for host in hosts["items"]]
